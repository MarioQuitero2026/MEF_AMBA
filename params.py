...
LOTES_E1: List[LoteConfig] = [
    LoteConfig(0.1346, 0.04, date(2027,  1,  1),  7, 0.10, 84, date(2027, 10, 31), 9, 15),
    LoteConfig(0.1346, 0.10, date(2027,  8, 31),  7, 0.10, 84, date(2028,  5, 31), 9, 15),
    LoteConfig(0.1346, 0.16, date(2028,  3, 31),  7, 0.15, 84, date(2028, 12, 31), 9, 15),
    LoteConfig(0.1346, 0.18, date(2028, 10, 31),  7, 0.10, 84, date(2029,  7, 31), 9, 15),
    LoteConfig(0.1346, 0.11, date(2029,  5, 31),  7, 0.05, 84, date(2030,  2, 28), 9, 15),
    LoteConfig(0.1346, 0.06, date(2029, 12, 31),  7, 0.15, 84, date(2030,  9, 30), 9, 15),
]

# Etapa 2 — 4 lotes activos
LOTES_E2: List[LoteConfig] = [
    LoteConfig(0.0577, 0.06, date(2030,  7, 31),  3, 0.10, 84, date(2030, 12, 31), 9, 15),
    LoteConfig(0.0577, 0.12, date(2030, 10, 31),  3, 0.05, 84, date(2031,  3, 31), 9, 15),
    LoteConfig(0.0385, 0.11, date(2031,  1, 31),  2, 0.05, 84, date(2031,  5, 31), 9, 15),
    LoteConfig(0.0385, 0.06, date(2031,  3, 31),  2, 0.15, 84, date(2031,  7, 31), 9, 15),
]
